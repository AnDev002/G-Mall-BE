...
exports.FlashSaleModule = FlashSaleModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [flash_sale_controller_1.FlashSaleController, flash_sale_controller_1.SellerFlashSaleController, flash_sale_controller_1.StoreFlashSaleController],
        providers: [flash_sale_service_1.FlashSaleService, prisma_service_1.PrismaService],
    })
], FlashSaleModule);
