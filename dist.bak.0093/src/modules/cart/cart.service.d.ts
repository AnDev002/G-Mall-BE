...
export declare class CartService {
    ...
    private getCartKey;
    private buildCartField;
    private parseCartField;
    ...
    removeItem(userId: string, field: string): Promise<{
        success: boolean;
    }>;
    updateQuantity(userId: string, field: string, quantity: number): Promise<{
        success: boolean;
    }>;
