...
const reject_payout_dto_1 = require("./dto/reject-payout.dto");
...
], FinanceController.prototype, "getRevenueStats", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], FinanceController.prototype, "getPayoutRequests", null);
__decorate([
    (0, common_1.Patch)('payouts/:id/approve'),
...
__decorate([
    (0, common_1.Patch)('payouts/:id/reject'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, reject_payout_dto_1.RejectPayoutDto]),
    __metadata("design:returntype", Promise)
