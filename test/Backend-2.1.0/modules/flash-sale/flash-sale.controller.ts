...
export class FlashSaleController {
  ...
  @Post('register')
  registerProducts(@User() user: any, @Body() dto: RegisterFlashSaleDto) {
    // user.shopId hoặc user.id tùy vào cách bạn lưu trong JWT
    const sellerId = user.shopId; 
    return this.flashSaleService.registerProducts(sellerId, dto);
  }
}