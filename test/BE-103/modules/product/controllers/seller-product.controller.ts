...
import { Controller, Get, Post, Body, UseGuards, Request, Patch, Param, Query, ParseIntPipe } from '@nestjs/common';
...
export class SellerProductController {
  ...
  async updateDiscount(
    @User() user: UserEntity, // Sử dụng interface đã định nghĩa ở trên
    @Param('id', ParseIntPipe) id: number,
    @Body() dto: UpdateProductDiscountDto,
  ) {
    // Gọi service updateDiscount (hàm này bạn đã thêm ở bước trước trong ProductWriteService)
